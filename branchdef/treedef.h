...
Bool_t jet_algoPF3_radionMatched[MAX_JETS];
Bool_t jet_algoPF2_radionMatched[MAX_JETS];
Bool_t jet_algoPF1_radionMatched[MAX_JETS];
...
Float_t jet_algoPF2_ptD[MAX_JETS];
Float_t jet_algoPF3_ptD[MAX_JETS];
Float_t jet_algoPF1_axis1[MAX_JETS];
Float_t jet_algoPF2_axis1[MAX_JETS];
Float_t jet_algoPF3_axis1[MAX_JETS];
Float_t jet_algoPF1_axis2[MAX_JETS];
Float_t jet_algoPF2_axis2[MAX_JETS];
Float_t jet_algoPF3_axis2[MAX_JETS];
Float_t jet_algoPF1_pull[MAX_JETS];
Float_t jet_algoPF2_pull[MAX_JETS];
Float_t jet_algoPF3_pull[MAX_JETS];
Float_t jet_algoPF1_R[MAX_JETS];
Float_t jet_algoPF1_Rchg[MAX_JETS];
Float_t jet_algoPF1_Rneutral[MAX_JETS];
Float_t jet_algoPF2_R[MAX_JETS];
Float_t jet_algoPF2_Rchg[MAX_JETS];
Float_t jet_algoPF2_Rneutral[MAX_JETS];
Float_t jet_algoPF3_R[MAX_JETS];
Float_t jet_algoPF3_Rchg[MAX_JETS];
Float_t jet_algoPF3_Rneutral[MAX_JETS];
